...
//
		{
			...
			pukiwikiPanel.add(wikiConnectButton);
...
//							            debugger.readFromPukiwikiPageAndSetData(urlTextField.getText());
						        ...
						        saveProperties();
							    mainController.parseCommandWithReturn("wikiConnectButton Clicked", urlx);
							    repaint();
//							            setting.setProperty("managerUrl", urlTextField.getText());
			...
			pukiwikiPanel.add(disConnectButton);
...
//		String pwdx2=new String(pwd2);
	...
	public String parseCommandWithReturn(String x, String v) {
...
//		this.putMessage(x+"-"+v);
		...
		if(x.equals("wikiStartWatching")){
			saveProperties();
			String rtn=mainController.parseCommandWithReturn("wikiStartWatching", "");
			return rtn;
		}		
		else
