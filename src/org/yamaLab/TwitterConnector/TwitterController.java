...
public class TwitterController  implements InterpreterInterface
{
	...
	public String CONSUMER_KEY = ""; // dev.twitter.com �ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ
	public String CONSUMER_SECRET = ""; // dev.twitter.com �ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ
...
//        mTwitterController=activity.mTwitterController;
        //�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ
//	    SharedPreferences pref = context.getSharedPreferences("Twitter_setting", context.MODE_PRIVATE);
	    //�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽK�ｿｽ�ｿｽ�ｿｽv�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ�ｿｽ
...
//					new connectTwitterTask().execute("");
	...
	private void loginTwitter(){
        ...
        System.out.println("閾ｪ蛻�縺ｮ蜷榊燕�ｼ�" + user.getScreenName());
        service.parseCommand("guiMessage","twitter login/閾ｪ蛻�縺ｮ蜷榊燕�ｼ�" + user.getScreenName());
        System.out.println("讎りｦ√��縲�縲��ｼ�" + user.getDescription());
        service.parseCommand("guiMessage","twitter login/讎りｦ√��縲�縲��ｼ�" + user.getDescription());
//        for (Status status : list_status) {
//            System.out.println("繝�繧､繝ｼ繝茨ｼ�" + status.getText());
//        	service.parseCommand("guiMessage","繝�繧､繝ｼ繝茨ｼ�" + status.getText());        
//          }
        }
        catch(Exception e){
        	System.out.println("twitter error:"+e.toString());
            service.parseCommand("guiMessage","twitter error�ｼ�" + e.toString());
